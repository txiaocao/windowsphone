var cc = cc || {};
cc._tmp = cc._tmp || {}, cc._LogInfos = {}, window._p, _p = window, _p.DeviceOrientationEvent, _p.DeviceMotionEvent, _p = Object.prototype, _p._super, _p.ctor, delete window._p, cc.newElement = function(e) {
        return document.createElement(e)
    }, cc._addEventListener = function(e, t, n, r) {
        e.addEventListener(t, n, r)
    }, cc.each = function(e, t, n) {
        if (!e) return;
        if (e instanceof Array) {
            for (var r = 0, i = e.length; r < i; r++)
                if (t.call(n, e[r], r) === !1) return
        } else
            for (var s in e)
                if (t.call(n, e[s], s) === !1) return
    }, cc.isCrossOrigin = function(e) {
        if (!e) return cc.log("invalid URL"), !1;
        var t = e.indexOf("://");
        if (t == -1) return !1;
        var n = e.indexOf("/", t + 3),
        ...
        _counterFunc: function(e) {
            ...
            var f = Array.apply(null, arguments).slice(1),
                l = f.length;
            l == 0 ? f = null : l == 1 && (f = f[0]), r[this.index] = f, t.count--, u && u.call(a, f, n - t.count, n), t.count == 0 && s && s.apply(o, [null, r])
        },
        _emptyFunc: function() {},
        parallel: function(e, t, n) {
            var r = cc.async;
            if (n !== undefined) typeof t == "function" && (t = {
                trigger: t
            }), t.cb = n || t.cb;
            else if (t !== undefined) typeof t == "function" && (t = {
                cb: t
            });
            else {
                if (e === undefined) throw "arguments error!";
                t = {}
            }
            var i = e instanceof Array,
                s = i ? e.length : Object.keys(e).length;
            if (s == 0) {
                t.cb && t.cb.call(t.cbTarget, null);
                return
            }
            var o = i ? [] : {},
                u = {
            ...
            cc.each(e, function(e, n) {
                if (u.err) return !1;
                var i = !t.cb && !t.trigger ? r._emptyFunc : r._counterFunc.bind({
                    counter: u,
                    index: n
                });
                e(i, n)
        ...
        map: function(e, t, n) {
            ...
            if (i === 3) t.cb = n || t.cb;
            else if (i < 2) throw "arguments error!";
            typeof t == "function" && (t = {
                iterator: t
            });
            if (n !== undefined) t.cb = n || t.cb;
            else if (e === undefined) throw "arguments error!";
            var s = e instanceof Array,
                o = s ? e.length : Object.keys(e).length;
            if (o === 0) {
                t.cb && t.cb.call(t.cbTarget, null);
                return
            }
            ...
            cc.each(e, function(e, n) {
                if (a.err) return !1;
                var i = t.cb ? r._counterFunc.bind({
                    counter: a,
                    index: n
                }) : r._emptyFunc;
                t.iterator.call(t.iteratorTarget, e, n, i)
            })
        }
    }, cc.path = {
        join: function() {
            var e = arguments.length,
                t = "";
            for (var n = 0; n < e; n++) t = (t + (t == "" ? "" : "/") + arguments[n]).replace(/(\/|\\\\)$/, "");
            return t
        },
        extname: function(e) {
            var t = /(\.[^\.\/\?\\]*)(\?.*)?$/.exec(e);
        ...
        changeBasename: function(e, t, n) {
            if (t.indexOf(".") == 0) return this.changeExtname(e, t);
            var r = e.indexOf("?"),
                i = "",
                s = n ? this.extname(e) : "";
        ...
        _getArgs4Js: function(e) {
            var t = e[0],
                ...
                r = e[2],
                i = ["", null, null];
            if (e.length === 1) i[1] = t instanceof Array ? t : [t];
            else if (e.length === 2) typeof n == "function" ? (i[1] = t instanceof Array ? t : [t], i[2] = n) : (i[0] = t || "", i[1] = n instanceof Array ? n : [n]);
            else {
                if (e.length !== 3) throw "arguments error to load js!";
        ...
        loadJs: function(e, t, n) {
            ...
            navigator.userAgent.indexOf("Trident/5") > -1 ? r._loadJs4Dependency(s[0], s[1], 0, s[2]) : cc.async.map(s[1], function(e, t, n) {
                var o = cc.path.join(s[0], e);
                if (i[o]) return n(null);
                r._createScript(o, !1, n)
            }, s[2])
        },
        ...
        _loadJsImg: function() {
            ...
            if (!t) {
                ...
                n.style.backgroundColor = "transparent", n.parentNode.appendChild(t);
        ...
        loadImg: function(e, t, n) {
            ...
            var i = new Image;
            return r.isCrossOrigin && location.origin != "file://" && (i.crossOrigin = "Anonymous"), cc._addEventListener(i, "load", function() {
                this.removeEventListener("load", arguments.callee, !1), this.removeEventListener("error", arguments.callee, !1), n && n(null, i)
            }), cc._addEventListener(i, "error", function() {
                this.removeEventListener("error", arguments.callee, !1), n && n("load image failed")
            }), i.src = e, i
        },
        _loadResIterator: function(e, t, n) {
            ...
            var o = r.cache[i];
            if (o) return n(null, o);
            var u = r._register[s.toLowerCase()];
            if (!u) return cc.error("loader for [" + s + "] not exists!"), n();
        ...
        getUrl: function(e, t) {
            ...
            return t = cc.path.join(e || "", t), t
        },
        load: function(e, t, n) {
            if (n !== undefined) typeof t == "function" && (t = {
                trigger: t
            });
            else if (t !== undefined) typeof t == "function" && (n = t, t = {});
            else {
                if (e === undefined) throw "arguments error!";
                t = {}
            }
            t.cb = function(e, t) {
                e && cc.log(e), n && n(t)
            }, e instanceof Array || (e = [e]), t.iterator = this._loadResIterator, t.iteratorTarget = this, cc.async.map(e, t)
        },
        ...
        loadAliases: function(e, t) {
            var n = this,
                r = n.getRes(e);
            r ? n._handleAliases(r.filenames, t) : n.load(e, function(e) {
                n._handleAliases(e[0].filenames, t)
            })
        },
        register: function(e, t) {
            if (!e || !t) return;
            var n = this;
            if (typeof e == "string") return this._register[e.trim().toLowerCase()] = t;
            for (var r = 0, i = e.length; r < i; r++) n._register["." + e[r].trim().toLowerCase()] = t
        },
        getRes: function(e) {
    ...
    function() {
        var e = window,
            t, n, r = "undefined";
        typeof document.hidden !== r ? (t = "hidden", n = "visibilitychange") : typeof document.mozHidden !== r ? (t = "mozHidden", n = "mozvisibilitychange") : typeof document.msHidden !== r ? (t = "msHidden", n = "msvisibilitychange") : typeof document.webkitHidden !== r && (t = "webkitHidden", n = "webkitvisibilitychange");
        var i = function() {
        ...
        t ? cc._addEventListener(document, n, function() {
            document[t] ? i() : s()
        }, !1) : (cc._addEventListener(e, "blur", i, !1), cc._addEventListener(e, "focus", s, !1)), "onpageshow" in window && "onpagehide" in window && (cc._addEventListener(e, "pagehide", i, !1), cc._addEventListener(e, "pageshow", s, !1)), e = null, n = null
    }(), cc.log = function() {
        ...
        var n = cc.sys = {};
        n.OS_WINDOWS = "Windows", n.OS_IOS = "iOS", n.OS_OSX = "OS X", n.OS_UNIX = "UNIX", n.OS_LINUX = "Linux", n.OS_ANDROID = "Android", n.OS_UNKNOWN = "Unknown", n.BROWSER_TYPE_WECHAT = "wechat", n.BROWSER_TYPE_ANDROID = "androidbrowser", n.BROWSER_TYPE_IE = "ie", n.BROWSER_TYPE_QQ = "qqbrowser", n.BROWSER_TYPE_MOBILE_QQ = "mqqbrowser", n.BROWSER_TYPE_UC = "ucbrowser", n.BROWSER_TYPE_360 = "360browser", n.BROWSER_TYPE_BAIDU_APP = "baiduboxapp", n.BROWSER_TYPE_BAIDU = "baidubrowser", n.BROWSER_TYPE_MAXTHON = "maxthon", n.BROWSER_TYPE_OPERA = "opera", n.BROWSER_TYPE_MIUI = "miuibrowser", n.BROWSER_TYPE_FIREFOX = "firefox", n.BROWSER_TYPE_SAFARI = "safari", n.BROWSER_TYPE_CHROME = "chrome", n.BROWSER_TYPE_UNKNOWN = "unknown";
        var r = window,
            i = r.navigator,
            s = document,
            o = s.documentElement,
            u = i.userAgent.toLowerCase();
        n.isMobile = u.indexOf("mobile") != -1 || u.indexOf("android") != -1;
        var a = n.BROWSER_TYPE_UNKNOWN,
            f = u.match(/micromessenger|qqbrowser|mqqbrowser|ucbrowser|360browser|baiduboxapp|baidubrowser|maxthon|trident|opera|miuibrowser|firefox/i) || u.match(/chrome|safari/i);
        f && f.length > 0 && (a = f[0].toLowerCase(), a == "micromessenger" ? a = n.BROWSER_TYPE_WECHAT : a === "safari" && u.match(/android.*applewebkit/) ? a = n.BROWSER_TYPE_ANDROID : a == "trident" && (a = n.BROWSER_TYPE_IE)), n.browserType = a;
        var l = cc.newElement("Canvas");
        cc._supportRender = !0, n._canUseCanvasNewBlendModes = function() {
            var e = document.createElement("canvas");
            e.width = 1, e.height = 1;
            var t = e.getContext("2d");
            return t.fillStyle = "#000", t.fillRect(0, 0, 1, 1), t.globalCompositeOperation = "multiply", t.fillStyle = "#fff", t.fillRect(0, 0, 1, 1), t.getImageData(0, 0, 1, 1).data[0] === 0
        }, n._supportCanvasNewBlendModes = n._canUseCanvasNewBlendModes();
        try {
            l.getContext("2d")
        } catch (c) {
            cc._supportRender = !1
        ...
        try {
            var h = n.localStorage = r.localStorage;
            h.setItem("storage", ""), h.removeItem("storage"), h = null
        } catch (c) {
            (c.name === "SECURITY_ERR" || c.name === "QuotaExceededError") && cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option"), n.localStorage = function() {}
        }
        var p = n.capabilities = {
            canvas: !0
        };
        o.ontouchstart !== undefined || i.msPointerEnabled ? p.touches = !0 : o.onmouseup !== undefined && (p.mouse = !0), o.onkeyup !== undefined && (p.keyboard = !0);
        if (r.DeviceMotionEvent || r.DeviceOrientationEvent) p.accelerometer = !0;
        var d = u.match(/(iPad|iPhone|iPod)/i) ? !0 : !1,
            v = u.match(/android/i) || i.platform.match(/android/i) ? !0 : !1,
            m = n.OS_UNKNOWN;
        i.appVersion.indexOf("Win") != -1 ? m = n.OS_WINDOWS : d ? m = n.OS_IOS : i.appVersion.indexOf("Mac") != -1 ? m = n.OS_OSX : i.appVersion.indexOf("X11") != -1 ? m = n.OS_UNIX : i.appVersion.indexOf("Linux") != -1 ? m = n.OS_LINUX : v && (m = n.OS_ANDROID), n.os = m
        ...
        var i = cc.$(e) || cc.$("#" + e),
            s, o, u;
        i.tagName == "CANVAS" ? (t = t || i.width, n = n || i.height, o = cc.container = cc.newElement("DIV"), s = cc._canvas = i, s.parentNode.insertBefore(o, s), s.appendTo(o), o.setAttribute("id", "Cocos2dGameContainer")) : (i.tagName != "DIV" && cc.log("Warning: target element is not a DIV or CANVAS"), t = t || i.clientWidth, n = n || i.clientHeight, o = cc.container = i, s = cc._canvas = cc.$(cc.newElement("CANVAS")), i.appendChild(s)), s.addClass("gameCanvas"), s.setAttribute("width", t || 480), s.setAttribute("height", n || 320), s.setAttribute("tabindex", 99), s.style.outline = "none", u = o.style, u.width = (t || 480) + "px", u.height = (n || 320) + "px", u.margin = "0 auto", u.position = "relative", u.overflow = "hidden", o.top = "100%", cc._renderContext = s.getContext("2d"), cc._mainRenderContextBackup = cc._renderContext, cc._renderContext.translate(0, s.height), cc._drawingUtil = cc.DrawingPrimitiveCanvas ? new cc.DrawingPrimitiveCanvas(cc._renderContext) : null, cc._gameDiv = o, cc._setContextMenuEnable(!1);
        if (cc.sys.isMobile) {
            var a = cc.newElement("style");
            a.type = "text/css", document.body.appendChild(a), a.textContent = "body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}"
        }
        ...
        setFrameRate: function(e) {
            var t = this,
                n = t.config,
                r = t.CONFIG_KEY;
            n[r.frameRate] = e, t._intervalId && clearInterval(t._intervalId), t._paused = !0, t._runMainLoop()
        },
        _runMainLoop: function() {
            var e = this,
                ...
                s = n[r.frameRate],
                o = cc.director;
            o.setDisplayStats(n[r.showFPS]), i.requestAnimFrame && s == 60 ? (t = function() {
                e._paused || (o.mainLoop(), i.requestAnimFrame(t))
            }, i.requestAnimFrame(t)) : (t = function() {
                o.mainLoop()
            }, e._intervalId = setInterval(t, 1e3 / s)), e._paused = !1
        },
        run: function(e) {
            var t = this,
                n = function() {
                    e && (t.config[t.CONFIG_KEY.id] = e), t._prepareCalled ? cc._supportRender && (t._checkPrepare = setInterval(function() {
                    ...
                    }, 10)) : t.prepare(function() {
                        cc._supportRender && (cc._setup(t.config[t.CONFIG_KEY.id]), t._runMainLoop(), t._eventHide = t._eventHide || new cc.EventCustom(t.EVENT_HIDE), t._eventHide.setUserData(t), t._eventShow = t._eventShow || new cc.EventCustom(t.EVENT_SHOW), t._eventShow.setUserData(t), t.onStart())
                    })
                };
        ...
        _initConfig: function() {
            var e = this,
                t = e.CONFIG_KEY,
                n = function(e) {
                    return e[t.engineDir] = e[t.engineDir] || "frameworks/cocos2d-html5", e[t.frameRate] = e[t.frameRate] || 60, e
                };
            if (document.ccConfig) e.config = n(document.ccConfig);
            else try {
                ...
                var o, u, a;
                i < r.length && (o = r[i].src, o && (a = /(.*)\//.exec(o)[0], cc.loader.resPath = a, o = cc.path.join(a, "project.json")), u = cc.loader._loadTxtSync(o)), u || (u = cc.loader._loadTxtSync("project.json"));
                var f = JSON.parse(u);
                e.config = n(f || {})
            } catch (l) {
        ...
        _getJsListOfModule: function(e, t, n) {
            ...
            var i = [],
                s = e[t];
            if (!s) throw "can not find module [" + t + "]";
            var o = cc.path;
            for (var u = 0, a = s.length; u < a; u++) {
                ...
                if (!l) {
                    ...
                    c && (i = i.concat(c))
                } else l.toLowerCase() == ".js" && i.push(o.join(n, f));
                r[f] = 1
            }
            return i
        },
        prepare: function(e) {
            ...
            t._prepareCalled = !0;
            var o = n[r.jsList] || [];
            if (cc.Class) s.loadJsWithImg("", o, function(n) {
                if (n) throw n;
                t._prepared = !0, e && e()
            });
            else {
    ...
    }, cc.game._initConfig(), cc.loader.loadBinary = function(e, t) {
        var n = this,
        ...
        if (/msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent)) {
            ...
            if (n.status != 200) return cc.log(r), null;
...
ClassManager.compileSuper.ClassManager = ClassManager,
    function() {
        ...
        if (e.__defineGetter__) n && e.__defineGetter__(t, n), r && e.__defineSetter__(t, r);
        else {
        ...
        if (!i && !s) {
            ...
            for (var l = 0; l < f.length; l++) {
                var c = f[l];
                if ((e.__lookupGetter__ ? e.__lookupGetter__(c) : Object.getOwnPropertyDescriptor(e, c)) || typeof e[c] != "function") continue;
                var h = e[c];
                if (u && h === n) {
                    i = c;
                    if (!a || s) break
        ...
        parse: function(e) {
            var t = this._parseXML(e),
                n = t.documentElement;
            if (n.tagName != "plist") throw "Not a plist file!";
            var r = null;
        ...
        _parseNode: function(e) {
            var t = null,
                n = e.tagName;
            if (n == "dict") t = this._parseDict(e);
            else if (n == "array") t = this._parseArray(e);
            else if (n == "string")
                if (e.childNodes.length == 1) t = e.firstChild.nodeValue;
                else {
                    t = "";
                    for (var r = 0; r < e.childNodes.length; r++) t += e.childNodes[r].nodeValue
                } else n == "false" ? t = !1 : n == "true" ? t = !0 : n == "real" ? t = parseFloat(e.firstChild.nodeValue) : n == "integer" && (t = parseInt(e.firstChild.nodeValue, 10));
            return t
        },
...
cc.$.trans = cc.$.pfx + "Transform", cc.$.translate = cc.$.hd ? function(e) {
        ...
        }, e.WHITE, cc.defineGetterSetter(e, "WHITE", e._getWhite), e.YELLOW, cc.defineGetterSetter(e, "YELLOW", e._getYellow), e.BLUE, cc.defineGetterSetter(e, "BLUE", e._getBlue), e.GREEN, cc.defineGetterSetter(e, "GREEN", e._getGreen), e.RED, cc.defineGetterSetter(e, "RED", e._getRed), e.MAGENTA, cc.defineGetterSetter(e, "MAGENTA", e._getMagenta), e.BLACK, cc.defineGetterSetter(e, "BLACK", e._getBlack), e.ORANGE, cc.defineGetterSetter(e, "ORANGE", e._getOrange), e.GRAY, cc.defineGetterSetter(e, "GRAY", e._getGray)
    }, cc.Color = function(e, t, n, r) {
        this.r = e || 0, this.g = t || 0, this.b = n || 0, this.a = r || 255
    }, cc.color = function(e, t, n, r) {
        return e === undefined ? {
            r: 0,
            g: 0,
            b: 0,
            a: 255
        } : typeof e == "string" ? cc.hexToColor(e) : typeof e == "object" ? {
            r: e.r,
            g: e.g,
            b: e.b,
            a: e.a || 255
        ...
        objectForKey: function(e) {
            ...
            for (var n in t)
                if (t[n] === e) return this._valueMapTb[n];
            return null
        },
        ...
        removeObjectsForKeys: function(e) {
            if (e == null) return;
            for (var t = 0; t < e.length; t++) this.removeObjectForKey(e[t])
        },
        allKeys: function() {
            var e = [],
                t = this._keyMapTb;
    ...
    }, cc.assert(typeof cc._tmp.PrototypeColor == "function", cc._LogInfos.MissingFile, "CCTypesPropertyDefine.js"), cc._tmp.PrototypeColor(), delete cc._tmp.PrototypeColor, cc.Touches = [], cc.TouchesIntergerDict = {}, cc.EGLView = cc.Class.extend({
        _delegate: null,
        _frameSize: null,
        ...
        setResizeCallback: function(e) {
            if (typeof e == "function" || e == null) this._resizeCallback = e
        },
        _initFrameSize: function() {
            var e = this._frameSize;
            e.width = this._frame.clientWidth, e.height = this._frame.clientHeight
        },
        ...
        _setViewPortMeta: function(e, t) {
            if (this._isAdjustViewPort) {
                var n = {
                    ...
                    i, s;
                r.length == 0 ? (i = cc.newElement("meta"), i.name = "viewport", i.content = "", document.head.appendChild(i)) : i = r[0];
                if (cc.sys.isMobile && cc.sys.browserType == cc.sys.BROWSER_TYPE_FIREFOX) {
                    i.content = "initial-scale:1";
                    return
                }
                s = i.content;
                for (var o in n) {
        ...
        setResolutionPolicy: function(e) {
            var t = this;
            if (e instanceof cc.ResolutionPolicy) t._resolutionPolicy = e;
            else {
        ...
        setDesignResolutionSize: function(e, t, n) {
            ...
            var i = r._resolutionPolicy;
            if (!i) {
                cc.log(cc._LogInfos.EGLView_setDesignResolutionSize_2);
                return
            }
            i.preApply(r);
            var s = r._frameSize.width,
                o = r._frameSize.height;
            cc.sys.isMobile && r._setViewPortMeta(r._frameSize.width, r._frameSize.height), r._initFrameSize();
            if (n == r._resolutionPolicy && e == r._originalDesignResolutionSize.width && t == r._originalDesignResolutionSize.height && s == r._frameSize.width && o == r._frameSize.height) return;
            r._designResolutionSize = cc.size(e, t), r._originalDesignResolutionSize = cc.size(e, t);
            var u = i.apply(r, r._designResolutionSize);
            u.scale && u.scale.length == 2 && (r._scaleX = u.scale[0], r._scaleY = u.scale[1]);
            if (u.viewport) {
                var a = r._viewPortRect = u.viewport,
                    f = r._visibleRect;
                f.width = cc._canvas.width / r._scaleX, f.height = cc._canvas.height / r._scaleY, f.x = -a.x / r._scaleX, f.y = -a.y / r._scaleY
            }
            var l = cc.director;
            cc.winSize.width = l._winSizeInPoints.width = r._visibleRect.width, cc.winSize.height = l._winSizeInPoints.height = r._visibleRect.height, i.postApply(r), r._originalScaleX = r._scaleX, r._originalScaleY = r._scaleY, cc.DOM && cc.DOM._resetEGLViewDiv(), cc.visibleRect && cc.visibleRect.init(r._visibleRect)
        },
        ...
        _convertTouchesWithScale: function(e) {
            var t = this._viewPortRect,
                ...
                r = this._scaleY,
                i, s, o;
            for (var u = 0; u < e.length; u++) i = e[u], s = i._point, o = i._prevPoint, i._setPoint((s.x - t.x) / n, (s.y - t.y) / r), i._setPrevPoint((o.x - t.x) / n, (o.y - t.y) / r)
        }
        ...
        _buildResult: function(e, t, n, r, i, s) {
            ...
            return cc._renderContext.translate(o.x, o.y + r), this._result.scale = [i, s], this._result.viewport = o, this._result
        },
        preApply: function(e) {},
        apply: function(e, t) {
            return {
    ...
    function() {
            ...
            u = cc.ContentStrategy.extend({
                apply: function(e, t) {
                    var n = cc._canvas.width,
                        ...
                        u = r / s,
                        a, f, l;
                    return o < u ? (a = u, f = i * a, l = r) : (a = o, f = n, l = s * a), this._buildResult(n, r, f, l, a, a)
                }
            }),
        ...
        _getUnUsedIndex: function() {
            ...
            for (var t = 0; t < this._maxTouches; t++) {
                if (!(e & 1)) return this._indexBitsUsed |= 1 << t, t;
                e >>= 1
            }
            return -1
        },
        _removeUsedIndexBit: function(e) {
            if (e < 0 || e >= this._maxTouches) return;
            var t = 1 << e;
        ...
        handleTouchesBegin: function(e) {
            ...
            for (var u = 0, a = e.length; u < a; u++) {
                ...
                if (n == null) {
                    ...
                    r = this._touches[f] = t, o[i] = f, s.push(r)
                }
            }
            if (s.length > 0) {
        ...
        getHTMLElementPosition: function(e) {
            var t = document.documentElement,
                n = window,
                r = null;
            return typeof e.getBoundingClientRect == "function" ? r = e.getBoundingClientRect() : e instanceof HTMLCanvasElement ? r = {
                left: 0,
                top: 0,
                width: e.width,
                height: e.height
        ...
        _setDirtyForNode: function(e) {
            ...
            var t = e.getChildren();
            for (var n = 0, r = t.length; n < r; n++) this._setDirtyForNode(t[n])
        },
        pauseTarget: function(e, t) {
            var n = this._nodeListenersMap[e.__instanceId],
                r, i;
            if (n)
                for (r = 0, i = n.length; r < i; r++) n[r]._setPaused(!0);
            if (t === !0) {
                var s = e.getChildren();
                for (r = 0, i = s.length; r < i; r++) this.pauseTarget(s[r], !0)
            }
        },
        resumeTarget: function(e, t) {
            var n = this._nodeListenersMap[e.__instanceId],
                r, i;
            if (n)
                for (r = 0, i = n.length; r < i; r++) n[r]._setPaused(!1);
            this._setDirtyForNode(e);
            if (t === !0) {
                var s = e.getChildren();
                for (r = 0, i = s.length; r < i; r++) this.resumeTarget(s[r], !0)
            }
        },
        ...
        _forceAddEventListener: function(e) {
            ...
            } else this._setDirty(t, this.DIRTY_FIXED_PRIORITY)
        },
        ...
        _updateDirtyFlagForSceneGraph: function() {
            ...
            for (var i = 0, s = e.length; i < s; i++) {
                ...
                if (t)
                    for (var o = 0, u = t.length; o < u; o++) n = t[o], n && this._setDirty(n._getListenerID(), this.DIRTY_SCENE_GRAPH_PRIORITY)
            }
        ...
        _removeAllListenersInVector: function(e) {
            if (!e) return;
            var t;
            for (var n = 0; n < e.length;) t = e[n], t._setRegistered(!1), t._getSceneGraphPriority() != null && (this._dissociateNodeAndEventListener(t._getSceneGraphPriority(), t), t._setSceneGraphPriority(null)), this._inDispatch === 0 ? cc.arrayRemoveObject(e, t) : ++n
        },
        _removeListenersForListenerID: function(e) {
            ...
            var s = this._toAddedListeners,
                o;
            for (n = 0; n < s.length;) o = s[n], o && o._getListenerID() == e ? cc.arrayRemoveObject(s, o) : ++n
        },
        ...
        _sortEventListenersOfSceneGraphPriorityDes: function(e, t) {
            ...
            return n[t._getSceneGraphPriority().__instanceId] - n[e._getSceneGraphPriority().__instanceId]
        },
        _sortListenersOfFixedPriority: function(e) {
            ...
            for (var i = n.length; r < i;) {
                if (n[r]._getFixedPriority() >= 0) break;
                ++r
            }
            t.gt0Index = r
        },
        ...
        _onUpdateListeners: function(e) {
            ...
            var n = t.getFixedPriorityListeners(),
                ...
                i, s;
            if (r)
                for (i = 0; i < r.length;) s = r[i], s._isRegistered() ? ++i : cc.arrayRemoveObject(r, s);
            if (n)
                for (i = 0; i < n.length;) s = n[i], s._isRegistered() ? ++i : cc.arrayRemoveObject(n, s);
        ...
        _updateListeners: function(e) {
            ...
            for (var i in n) n[i].empty() && (delete r[i], delete n[i]);
            var s = this._toAddedListeners;
            if (s.length !== 0) {
                for (var o = 0, u = s.length; o < u; o++) this._forceAddEventListener(s[o]);
        ...
        _visitTarget: function(e, t) {
            ...
            if (i > 0) {
                ...
                for (; r < i; r++) u = n[r], u && this._visitTarget(u, !1)
            } else o[e.__instanceId] != null && (s[e.getGlobalZOrder()] || (s[e.getGlobalZOrder()] = []), s[e.getGlobalZOrder()].push(e.__instanceId));
            if (t) {
                var a = [];
                for (var f in s) a.push(f);
                a.sort(this._sortNumberAsc);
                var l = a.length,
                    c, h, p = this._nodePriorityMap;
                for (r = 0; r < l; r++) {
                    c = s[a[r]];
                    for (h = 0; h < c.length; h++) p[c[h]] = ++this._nodePriorityIndex
                }
        ...
        addListener: function(e, t) {
            ...
            } else cc.assert(typeof t != "number", cc._LogInfos.eventManager_addListener_3), e = cc.EventListener.create(e);
            if (!e.checkAvailable()) return;
            if (typeof t == "number") {
                if (t == 0) {
            ...
            } else e._setSceneGraphPriority(t), e._setFixedPriority(0), e._setRegistered(!0), this._addListener(e)
        },
        ...
        _removeListenerInVector: function(e, t) {
            ...
            for (var n = 0, r = e.length; n < r; n++) {
                var i = e[n];
                if (i == t) return i._setRegistered(!1), i._getSceneGraphPriority() != null && (this._dissociateNodeAndEventListener(i._getSceneGraphPriority(), i), i._setSceneGraphPriority(null)), this._inDispatch == 0 && cc.arrayRemoveObject(e, i), !0
            }
            return !1
        },
        ...
        removeAllListeners: function() {
            ...
            for (var n in e) t.indexOf(n) === -1 && this._removeListenersForListenerID(n)
        },
        ...
        dispatchEvent: function(e) {
            ...
            if (!e || !e.getType) throw "event is undefined";
        ...
        _arrayMakeObjectsPerformSelector: function(e, t) {
            ...
            var n, r = e.length,
                i, s = cc.Node.StateCallbackType;
            switch (t) {
                case s.onEnter:
                    for (n = 0; n < r; n++) i = e[n], i && i.onEnter();
                    break;
                case s.onExit:
                    for (n = 0; n < r; n++) i = e[n], i && i.onExit();
                    break;
                case s.onEnterTransitionDidFinish:
                    for (n = 0; n < r; n++) i = e[n], i && i.onEnterTransitionDidFinish();
                    break;
                case s.cleanup:
                    for (n = 0; n < r; n++) i = e[n], i && i.cleanup();
                    break;
                case s.updateTransform:
                    for (n = 0; n < r; n++) i = e[n], i && i.updateTransform();
                    break;
                case s.onExitTransitionDidStart:
                    for (n = 0; n < r; n++) i = e[n], i && i.onExitTransitionDidStart();
                    break;
                case s.sortAllChildren:
                    for (n = 0; n < r; n++) i = e[n], i && i.sortAllChildren();
                    break;
                default:
        ...
        _setAnchorX: function(e) {
            if (this._anchorPoint.x === e) return;
        ...
        _setAnchorY: function(e) {
            if (this._anchorPoint.y === e) return;
        ...
        _setHeight: function(e) {
            this._contentSize.height = e,
                this._anchorPointInPoints.y = e * this._anchorPoint.y, this.setNodeDirty()
        },
        ...
        cleanup: function() {
            this.stopAllActions(), this.unscheduleAllCallbacks(), cc.eventManager.removeListeners(this), this._arrayMakeObjectsPerformSelector(this._children, cc.Node.StateCallbackType.cleanup)
        },
        getChildByTag: function(e) {
            ...
            if (t != null)
                for (var n = 0; n < t.length; n++) {
                    var r = t[n];
                    if (r && r.tag == e) return r
                }
            return null
        },
        getChildByName: function(e) {
            if (!e) return cc.log("Invalid name"), null;
            var t = this._children;
        ...
        addChild: function(e, t, n) {
            ...
            cc.assert(e, cc._LogInfos.Node_addChild_3), cc.assert(e._parent === null, "child already added. It can't be added again"), this.addChildHelper(e, t, n, r, i)
        },
        addChildHelper: function(e, t, n, r, i) {
            this._children || (this._children = []), this._insertChild(e, t), i ? e.setTag(n) : e.setName(r), e.setParent(this), e.setOrderOfArrival(this.s_globalOrderOfArrival++), this._running && (e.onEnter(), this._isTransitionFinished && e.onEnterTransitionDidFinish()), this._cascadeColorEnabled && this._enableCascadeColor(), this._cascadeOpacityEnabled && this._enableCascadeOpacity()
        },
        getName: function() {
            return this._name
        },
        ...
        removeAllChildrenWithCleanup: function(e) {
            cc.log(cc._LogInfos.Node_removeAllChildrenWithCleanup), this.removeAllChildren(e)
        },
        ...
        sortAllChildren: function() {
            if (this._reorderChildDirty) {
                ...
                for (n = 1; n < t; n++) {
                    i = e[n], r = n - 1;
                    while (r >= 0) {
                        if (i._localZOrder < e[r]._localZOrder) e[r + 1] = e[r];
                        else {
                            if (!(i._localZOrder === e[r]._localZOrder && i.arrivalOrder < e[r].arrivalOrder)) break;
                            e[r + 1] = e[r]
                        }
                        r--
                    }
        ...
        onEnter: function() {
            this._isTransitionFinished = !1, this._running = !0, this._arrayMakeObjectsPerformSelector(this._children, cc.Node.StateCallbackType.onEnter), this.resume()
        },
        ...
        onExit: function() {
            this._running = !1, this.pause(), this._arrayMakeObjectsPerformSelector(this._children, cc.Node.StateCallbackType.onExit), this._componentContainer && this._componentContainer.removeAll()
        },
        ...
        nodeToWorldTransform: function() {
            ...
            for (var t = this._parent; t != null; t = t.parent) e = cc.affineTransformConcat(e, t.nodeToParentTransform());
            return e
        },
        ...
        convertToWorldSpace: function(e) {
            return e = e || cc.p(0, 0), cc.pointApplyAffineTransform(e, this.nodeToWorldTransform())
        },
        ...
        _setCachedParent: function(e) {
            if (this._cachedParent == e) return;
            this._cachedParent = e;
            var t = this._children;
            for (var n = 0, r = t.length; n < r; n++) t[n]._setCachedParent(e)
        },
        getCamera: function() {
        ...
        _getBoundingBoxToCurrentNode: function(e) {
            var t = cc.rect(0, 0, this._contentSize.width, this._contentSize.height),
                n = e == null ? this.nodeToParentTransform() : cc.affineTransformConcat(this.nodeToParentTransform(), e);
        ...
        setCascadeOpacityEnabled: function(e) {
            if (this._cascadeOpacityEnabled === e) return;
        ...
        setColor: function(e) {
            ...
            i && i.cascadeColor ? r = i.getDisplayedColor() : r = cc.color.WHITE, this.updateDisplayedColor(r), e.a !== undefined && !e.a_undefined && this.setOpacity(e.a)
        },
        ...
        setCascadeColorEnabled: function(e) {
            if (this._cascadeColorEnabled === e) return;
...
_p.ctor = function() {
    ...
    if (e._transformDirty) {
        ...
        if (i !== 1 || s !== 1) t.a *= a, t.c *= a, t.b *= f, t.d *= f;
...
}, cc.ALIGN_CENTER = 51, cc.ALIGN_TOP = 19, cc.ALIGN_TOP_RIGHT = 18, cc.ALIGN_RIGHT = 50, cc.ALIGN_BOTTOM_RIGHT = 34, cc.ALIGN_BOTTOM = 35, cc.ALIGN_BOTTOM_LEFT = 33, cc.ALIGN_LEFT = 49, cc.ALIGN_TOP_LEFT = 17, cc.PVRHaveAlphaPremultiplied_ = !1, cc.Texture2D = cc.Class.extend({
    _contentSize: null,
    _isLoaded: !1,
...
}), cc.assert(typeof cc._tmp.PrototypeTexture2D == "function", cc._LogInfos.MissingFile, "TexturesPropertyDefine.js"), cc._tmp.PrototypeTexture2D(), delete cc._tmp.PrototypeTexture2D, cc.textureCache = {
    _textures: {},
    _textureColorsCache: {},
    ...
    getKeyByTexture: function(e) {
        for (var t in this._textures)
            if (this._textures[t] == e) return t;
        return null
    },
    ...
    addUIImage: function(e, t) {
        ...
        if (t && this._textures[t]) return this._textures[t];
        var n = new cc.Texture2D;
...
_p.handleLoadedTexture = function(e) {
    ...
    return i ? (t && t.call(n), i) : (i = r[e] = new cc.Texture2D, i.url = e, cc.loader.getRes(e) ? i.handleLoadedTexture() : cc.loader._checkIsImageURL(e) ? cc.loader.load(e, function(e) {
        t && t.call(n)
    }) : cc.loader.cache[e] = cc.loader.loadImg(e, function(n, r) {
        if (n) return t ? t(n) : n;
        cc.textureCache.handleLoadedTexture(e), t && t(null, r)
    }), i)
}, _p = null, cc.Scene = cc.Node.extend({
    _className: "Scene",
    ctor: function() {
    ...
    init: function() {
        var e = this,
            t = 160,
            n = 200,
            r = e._bgLayer = cc.LayerColor.create(cc.color(255, 255, 255, 1));
    ...
    initWithResources: function(e, t) {
        typeof e == "string" && (e = [e]), this.resources = e || [], this.cb = t
    },
    _startLoading: function() {
        var e = this;
        e.unschedule(e._startLoading);
        var t = e.resources;
        e._length = t.length, e._count = 0, cc.loader.load(t, function(t, n) {
            e._count = n
        }, function() {
            e.cb && e.cb()
        }), e.schedule(e._updatePercent)
    },
    _updatePercent: function() {
        var e = this,
            ...
            n = e._length,
            r = t / n * 100 | 0;
        r = Math.min(r, 100), e._label.setString("Loading... " + r + "%"), t >= n && e.unschedule(e._updatePercent)
    }
...
p.bake = function() {
    if (!this._isBaked) {
        ...
        var e = this._children;
        for (var t = 0, n = e.length; t < n; t++) e[t]._setCachedParent(this);
    ...
    if (this._isBaked) {
        ...
        var e = this._children;
        for (var t = 0, n = e.length; t < n; t++) e[t]._setCachedParent(null)
    }
}, p.visit = function(e) {
    if (!this._isBaked) {
    ...
    for (var n = 0; n < t.length; n++) {
        ...
        if (r && r._visible)
            ...
            } else e = r._getBoundingBoxToCurrentNode()
    }
    return e
}, p = null, cc.LayerColor = cc.Layer.extend({
    _blendFunc: null,
    ...
    setBlendFunc: function(e, t) {
        var n = this;
        t === undefined ? n._blendFunc = e : n._blendFunc = {
            src: e,
            dst: t
        }, n._isLighterMode = n._blendFunc && n._blendFunc.src == 1 && n._blendFunc.dst == 771
    },
    _setWidth: null,
    _setHeight: null,
    _updateColor: null,
...
_p.ctor = function(e, t, n) {
    ...
    if (this._cacheDirty) {
        ...
        var f = o.getAnchorPointInPoints(),
            l = this._position;
        if (this._ignoreAnchorPointForPosition) a.translate(0 - u.x + l.x, u.height + u.y - l.y), o.setPosition(f.x + u.x - l.x, f.y + u.y - l.y);
        else {
        ...
        if (s > 0) {
            ...
            for (n = 0; n < s; n++) {
                p = i[n];
                if (!(p._localZOrder < 0)) break;
                p.visit(a)
            }
            r.draw(a);
            for (; n < s; n++) i[n].visit(a)
        } else r.draw(a);
        cc.view._resetScale(), this._cacheDirty = !1
    }
    o.visit(t), r.arrivalOrder = 0, t.restore()
    ...
    var e = cc.rect(0, 0, this._contentSize.width, this._contentSize.height),
        t = this.nodeToWorldTransform();
    e = cc.rectApplyAffineTransform(e, this.nodeToWorldTransform());
    if (!this._children || this._children.length === 0) return e;
    var n = this._children;
    for (var r = 0; r < n.length; r++) {
        var i = n[r];
        if (i && i._visible) {
    ...
    return e
}, _p = null, cc.assert(typeof cc._tmp.PrototypeLayerColor == "function", cc._LogInfos.MissingFile, "CCLayerPropertyDefine.js"), cc._tmp.PrototypeLayerColor(), delete cc._tmp.PrototypeLayerColor, cc.LayerGradient = cc.LayerColor.extend({
    _startColor: null,
    _endColor: null,
    _startOpacity: 255,
    _endOpacity: 255,
...
_p.draw = function(e) {
    var t = e || cc._renderContext,
        n = this;
    n._isLighterMode && (t.globalCompositeOperation = "lighter"), t.save();
    var r = n._displayedOpacity / 255,
        i = cc.view.getScaleX(),
        s = cc.view.getScaleY(),
        o = n.width * i,
        u = n.height * s,
        a = t.createLinearGradient(n._gradientStartPoint.x * i, n._gradientStartPoint.y * s, n._gradientEndPoint.x * i, n._gradientEndPoint.y * s),
        f = n._displayedColor,
        l = n._endColor;
...
}, _p = null, cc.assert(typeof cc._tmp.PrototypeLayerGradient == "function", cc._LogInfos.MissingFile, "CCLayerPropertyDefine.js"), cc._tmp.PrototypeLayerGradient(), delete cc._tmp.PrototypeLayerGradient, cc.LayerMultiplex = cc.Layer.extend({
    _enabledLayer: 0,
    _layers: null,
    ...
    function n() {
        ...
        for (var u = 0; u < 4; u++) {
            ...
            var f = n.tempCtx.getImageData(0, 0, r, i),
                l = f.data;
            for (var c = 0; c < o.length; c += 4) l[c] = u === 0 ? o[c] : 0, l[c + 1] = u === 1 ? o[c + 1] : 0, l[c + 2] = u === 2 ? o[c + 2] : 0, l[c + 3] = o[c + 3];
            a.putImageData(f, 0, 0)
        }
        e.onload = null
    }
    if (e.channelCache) return e.channelCache;
    ...
    sortAllChildren: function() {
        if (this._reorderChildDirty) {
            ...
            this._batchNode && this._arrayMakeObjectsPerformSelector(e, cc.Node.StateCallbackType.sortAllChildren), this._reorderChildDirty = !1
        }
    },
    reorderChild: function(e, t) {
    ...
    removeAllChildren: function(e) {
        var t = this._children,
            n = this._batchNode;
        if (n && t != null)
            for (var r = 0, i = t.length; r < i; r++) n.removeSpriteFromAtlas(t[r]);
    ...
    setDirtyRecursively: function(e) {
        ...
        var t = this._children,
            n, r = t ? t.length : 0;
        for (var i = 0; i < r; i++) n = t[i], n instanceof cc.Sprite && n.setDirtyRecursively(!0)
    },
    ...
    _setReorderChildDirtyRecursively: function() {
        if (!this._reorderChildDirty) {
            ...
            var e = this._parent;
            while (e && e != this._batchNode) e._setReorderChildDirtyRecursively(), e = e.parent
        }
    },
    getTexture: function() {
    ...
    _softInit: function(e, t, n) {
        if (e === undefined) cc.Sprite.prototype.init.call(this);
        else if (typeof e == "string")
            if (e[0] === "#") {
                var r = e.substr(1, e.length - 1),
                    i = cc.spriteFrameCache.getSpriteFrame(r);
                this.initWithSpriteFrame(i)
            } else cc.Sprite.prototype.init.call(this, e, t);
        else if (typeof e == "object")
            if (e instanceof cc.Texture2D) this.initWithTexture(e, t, n);
            else if (e instanceof cc.SpriteFrame) this.initWithSpriteFrame(e);
    ...
    initWithFile: function(e, t) {
        ...
        var n = cc.textureCache.textureForKey(e);
        if (!n) return n = cc.textureCache.addImage(e), this.initWithTexture(n, t || cc.rect(0, 0, n._contentSize.width, n._contentSize.height));
        if (!t) {
    ...
    _changeTextureColor: function() {
        ...
        if (t && n.validRect && this._originalTexture) {
            ...
            if (!e) return;
            this._colorized = !0, e instanceof HTMLCanvasElement && !this._rectRotated && !this._newTextureWhenChangeColor ? cc.generateTintImageWithMultiply(this._originalTexture._htmlElementObj, this._displayedColor, n, e) : (e = cc.generateTintImageWithMultiply(this._originalTexture._htmlElementObj, this._displayedColor, n), t = new cc.Texture2D, t.initWithElement(e), t.handleLoadedTexture(), this.texture = t)
        }
    },
...
_p._spriteFrameLoadedCallback = function(e) {
    ...
    t === undefined ? (n.src = e.src, n.dst = e.dst) : (n.src = e, n.dst = t), this._isLighterMode = n && (n.src == cc.SRC_ALPHA && n.dst == cc.ONE || n.src == cc.ONE && n.dst == cc.ONE)
}, _p.init = function() {
    var e = this;
    ...
    if (!cc.Node.prototype.init.call(r)) return !1;
    ...
    var o = e.isLoaded();
    r._textureLoaded = o;
    if (!o) return r._rectRotated = n, t && (r._rect.x = t.x, r._rect.y = t.y, r._rect.width = t.width, r._rect.height = t.height), e.addLoadedEventListener(r._textureLoadedCallback, r), !0;
    ...
    var t = this;
    if (t._textureLoaded) return;
    t._textureLoaded = !0;
    var n = t._rect;
    n ? cc._rectEqualToZero(n) && (n.width = e.width, n.height = e.height) : n = cc.rect(0, 0, e.width, e.height), t._originalTexture = e, t.texture = e, t.setTextureRect(n, t._rectRotated), t.batchNode = t._batchNode, t._callLoadedEventCallbacks()
    ...
    e._hasChildren && e._arrayMakeObjectsPerformSelector(e._children, cc.Node.StateCallbackType.updateTransform)
    ...
    var t = this,
        n = t.color;
    if (n.r === e.r && n.g === e.g && n.b === e.b) return;
    cc.Node.prototype.setColor.call(t, e)
}, _p.updateDisplayedColor = function(e) {
    var t = this;
    cc.Node.prototype.updateDisplayedColor.call(t, e), t._changeTextureColor(), t._setNodeDirtyForCache()
}, _p.setSpriteFrame = function(e) {
    var t = this;
    typeof e == "string" && (e = cc.spriteFrameCache.getSpriteFrame(e), cc.assert(e, cc._LogInfos.CCSpriteBatchNode_setSpriteFrame)), t.setNodeDirty(!0);
    var n = e.getOffset();
    ...
    if (!t._textureLoaded) return;
    var n = e || cc._renderContext;
    t._isLighterMode && (n.globalCompositeOperation = "lighter");
    ...
    if (t._flippedX || t._flippedY) n.save(), t._flippedX && (f = -u.x - s.width, n.scale(-1, 1)), t._flippedY && (l = u.y, n.scale(1, -1));
    f *= r, l *= i;
...
}), delete _p, cc.assert(typeof cc._tmp.PrototypeSprite == "function", cc._LogInfos.MissingFile, "SpritesPropertyDefine.js"), cc._tmp.PrototypeSprite(), delete cc._tmp.PrototypeSprite, cc.AnimationFrame = cc.Class.extend({
    _spriteFrame: null,
    _delayPerUnit: 0,
    _userInfo: null,
    ctor: function(e, t, n) {
    ...
    ctor: function(e, t, n) {
        this._frames = [];
        if (e === undefined) this.initWithSpriteFrames(null, 0);
        else {
            var r = e[0];
    ...
    _copyFrames: function() {
        var e = [];
        for (var t = 0; t < this._frames.length; t++) e.push(this._frames[t].clone());
        return e
    },
    copy: function(e) {
    ...
    _addAnimationsWithDictionary: function(e, t) {
        ...
        if (i) {
            ...
            var s = i.spritesheets,
                ...
                u = cc.path;
            for (var a = 0; a < s.length; a++) o.addSpriteFrames(u.changeBasename(t, s[a]))
        }
        switch (r) {
            case 1:
    ...
    initWithTexture: function(e, t, n, r, i) {
        arguments.length === 2 && (t = cc.rectPointsToPixels(t)), r = r || cc.p(0, 0), i = i || t, n = n || !1, typeof e == "string" ? (this._texture = null, this._textureFilename = e) : e instanceof cc.Texture2D && this.setTexture(e), e = this.getTexture();
        if (e && e.url) {
            var s, o;
            n ? (s = t.x + t.height, o = t.y + t.width) : (s = t.x + t.width, o = t.y + t.height), s > e.width && cc.error(cc._LogInfos.RectWidth, e.url), o > e.height && cc.error(cc._LogInfos.RectHeight, e.url)
        }
        return this._rectInPixels = t, this._rect = cc.rectPixelsToPoints(t), this._offsetInPixels.x = r.x, this._offsetInPixels.y = r.y, cc._pointPixelsToPointsOut(r, this._offset), this._originalSizeInPixels.width = i.width, this._originalSizeInPixels.height = i.height, cc._sizePixelsToPointsOut(i, this._originalSize), this._rotated = n, !0
    }
    ...
    _getFrameConfig: function(e) {
        ...
        if (t._inited) return this._frameConfigCache[e] = t, t;
        var n = t.frames,
            r = t.metadata || t.meta,
            i = {},
            s = {},
        ...
        for (var a in n) {
            ...
            } else if (o == 1 || o == 2) l.rect = this._rectFromString(f.frame), l.rotated = f.rotated || !1, l.offset = this._pointFromString(f.offset), l.size = this._sizeFromString(f.sourceSize);
            else if (o == 3) {
    ...
    addSpriteFrames: function(e, t) {
        ...
        } else t instanceof cc.Texture2D || (typeof t == "string" ? t = cc.textureCache.addImage(t) : cc.assert(0, cc._LogInfos.spriteFrameCache_addSpriteFrames_3));
    ...
    _checkConflict: function(e) {
        var t = e.frames;
        for (var n in t) this._spriteFrames[n] && cc.log(cc._LogInfos.spriteFrameCache__checkConflict, n)
    },
    ...
    removeSpriteFramesFromFile: function(e) {
        ...
        for (var o in s)
            if (n[o]) {
                delete n[o];
                for (var u in r) r[u] == o && delete r[u]
            }
    },
    removeSpriteFramesFromTexture: function(e) {
        ...
        for (var i in n) {
            ...
            if (s && s.getTexture() == e) {
                delete n[i];
                for (var o in r) r[o] == i && delete r[o]
            }
        }
    },
...
}, cc.g_NumberOfDraws = 0, cc.Director = cc.Class.extend({
    _landscape: !1,
    ...
    calculateDeltaTime: function() {
        var e = Date.now();
        this._nextDeltaTimeZero ? (this._deltaTime = 0, this._nextDeltaTimeZero = !1) : this._deltaTime = (e - this._lastUpdate) / 1e3, this._lastUpdate = e
    },
    drawScene: function() {
    ...
    runScene: function(e) {
        ...
        if (!this._runningScene) this.pushScene(e), this.startAnimation();
        else {
...
_p.setProjection = function(e) {
    ...
    return cc.p(0, 0)
}, cc.PRIORITY_NON_SYSTEM = cc.PRIORITY_SYSTEM + 1, cc.arrayVerifyType = function(e, t) {
    if (e && e.length > 0)
        for (var n = 0; n < e.length; n++)
            if (!(e[n] instanceof t)) return cc.log(cc._LogInfos.arrayVerifyType), !1;
    return !0
    ...
    for (var n = 0, r = t.length; n < r; n++) cc.arrayRemoveObject(e, t[n])
    ...
    _doCallback: function() {
        var e = this;
        typeof e._callback == "string" ? e._target[e._callback](e._elapsed) : e._callback.call(e._target, e._elapsed)
    },
    update: function(e) {
        var t = this;
        if (t._elapsed == -1) t._elapsed = 0, t._timesExecuted = 0;
        else {
            var n = t._target,
                r = t._callback;
    ...
    update: function(e) {
        ...
        for (o = 0, u = n.length; o < u && o >= 0; o++) {
            var a = t._updates[o];
            for (var f = 0, l = a.length; f < l; f++) i = a[f], !i.paused && !i.markedForDeletion && i.target.update(e)
        }
        for (o = 0, u = r.length; o < u; o++) {
            ...
            if (!s.paused)
                for (s.timerIndex = 0; s.timerIndex < s.timers.length; s.timerIndex++) s.currentTimer = s.timers[s.timerIndex], s.currentTimerSalvaged = !1, s.currentTimer.update(e), s.currentTimer = null;
    ...
    unscheduleAllCallbacksWithMinPriority: function(e) {
        var t = this,
            n = t._arrayForTimers,
            r = t._updates;
        for (var i = 0, s = n.length; i < s; i++) t.unscheduleAllCallbacksForTarget(n[i].target);
        for (var i = 2; i >= 0; i--) {
            if (i == 1 && e > 0 || i == 0 && e >= 0) continue;
            var o = r[i];
            for (var u = 0, a = o.length; u < a; u++) t.unscheduleUpdateForTarget(o[u].target)
        }
    },
    ...
    pauseAllTargetsWithMinPriority: function(e) {
        var t = [],
            ...
            s = n._updates;
        for (var o = 0, u = i.length; o < u; o++) r = i[o], r && (r.paused = !0, t.push(r.target));
        for (var o = 0, u = s.length; o < u; o++) {
            var a = s[o];
            for (var f = 0, l = a.length; f < l; f++) r = a[f], r && (r.paused = !0, t.push(r.target))
        }
        return t
    },
    ...
    _checkNextline: function(e, t) {
        var n = this._measure(e),
            ...
            i = e.indexOf("\n");
        if (r * .8 >= i && i > 0) return i + 1;
        if (n < t) return e.length;
        var s = !1,
            o = t + 1,
            u = -1,
            a = r,
            f, l = cc.LabelTTF._checkRegEx,
            c = cc.LabelTTF._reverseCheckRegEx,
            h = cc.LabelTTF._checkEnRegEx,
            p = e.substr(r);
        while (f = l.exec(p)) {
            a += f[0].length;
            var d = e.substr(0, a);
        ...
        p = e.substr(0, r), u = r;
        while (f = c.exec(p)) {
            u = f[1].length, p = f[1], o = this._measure(p);
            if (o < t) {
                h.test(f[2]) && u++;
                break
            }
    ...
    initWithString: function(e, t, n, r, i, s) {
        var o;
        return e ? o = e + "" : o = "", n = n || 16, r = r || cc.size(0, n), i = i || cc.TEXT_ALIGNMENT_LEFT, s = s || cc.VERTICAL_TEXT_ALIGNMENT_TOP, this._opacityModifyRGB = !1, this._dimensions = cc.size(r.width, r.height), this._fontName = t || "Arial", this._hAlignment = i, this._vAlignment = s, this._fontSize = n, this._fontStyleStr = this._fontSize + "px '" + t + "'", this._fontClientHeight = cc.LabelTTF.__getFontHeightByDiv(t, this._fontSize), this.string = o, this._setColorsString(), this._updateTexture(), this._needUpdateTexture = !1, !0
    },
    ...
    _setShadowOffset: function(e) {
        ...
        if (this._shadowOffset.x != e.x || this._shadowOffset.y != e.y) this._shadowOffset.x = e.x, this._shadowOffset.y = e.y, this._needUpdateTexture = !0
    },
    ...
    enableStroke: function(e, t) {
        ...
        if (n.r !== e.r || n.g !== e.g || n.b !== e.b) n.r = e.r, n.g = e.g, n.b = e.b, this._setColorsString();
    ...
    _setStrokeStyle: function(e) {
        ...
        if (t.r !== e.r || t.g !== e.g || t.b !== e.b) t.r = e.r, t.g = e.g, t.b = e.b, this._setColorsString(), this._needUpdateTexture = !0
    },
    ...
    setDimensions: function(e, t) {
        ...
        if (n != this._dimensions.width || t != this._dimensions
            .height) this._dimensions.width = n, this._dimensions.height = t, this._updateString(), this._needUpdateTexture = !0
    },
    ...
    _drawTTFInCanvas: function(e) {
        ...
        } else i === cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM ? (l && e.strokeText(this._string, a, f), e.fillText(this._string, a, f)) : i === cc.VERTICAL_TEXT_ALIGNMENT_TOP ? (f -= r, l && e.strokeText(this._string, a, f), e.fillText(this._string, a, f)) : (f -= r * .5, l && e.strokeText(this._string, a, f), e.fillText(this._string, a, f))
    },
    ...
    _updateTTF: function() {
        ...
        if (e !== 0) {
            var i = this._string;
            this._strings = [];
            for (t = 0, n = this._string.length; t < n;) {
                var s = this._checkNextline(i.substr(t), e),
                    o = i.substr(t, s);
                this._strings.push(o), t += s
            }
        } else {
            this._strings = this._string.split("\n");
            for (t = 0, n = this._strings.length; t < n; t++) r.push(this._measure(this._strings[t]))
        }
        this._strings.length > 0 && (this._isMultiLine = !0);
        var u, a = 0,
            f = 0;
        this._strokeEnabled && (a = f = this._strokeSize * 2);
        if (this._shadowEnabled) {
            var l = this._shadowOffset;
            a += Math.abs(l.x) * 2, f += Math.abs(l.y) * 2
        }
        e === 0 ? this._isMultiLine ? u = cc.size(0 | Math.max.apply(Math, r) + a, 0 | this._fontClientHeight * this._strings.length + f) : u = cc.size(0 | this._measure(this._string) + a, 0 | this._fontClientHeight + f) : this._dimensions.height === 0 ? this._isMultiLine ? u = cc.size(0 | e + a, 0 | this._fontClientHeight * this._strings.length + f) : u = cc.size(0 | e + a, 0 | this._fontClientHeight + f) : u = cc.size(0 | e + a, 0 | this._dimensions.height + f), this.setContentSize(u), this._strokeShadowOffsetX = a, this._strokeShadowOffsetY = f;
        var c = this._anchorPoint;
        this._anchorPointInPoints.x = a * .5 + (u.width - a) * c.x, this._anchorPointInPoints.y = f * .5 + (u.height - f) * c.y
    },
    getContentSize: function() {
    ...
    _updateTexture: function() {
        var e = this._getLabelContext(),
            t = this._labelCanvas,
            n = this._contentSize;
        if (this._string.length === 0) return t.width = 1, t.height = n.height, this.setTextureRect(cc.rect(0, 0, 1, n.height)), !0;
...
_p.setColor = function(e) {
...
}, _p = null, cc.assert(typeof cc._tmp.PrototypeLabelTTF == "function", cc._LogInfos.MissingFile, "LabelTTFPropertyDefine.js"), cc._tmp.PrototypeLabelTTF(), delete cc._tmp.PrototypeLabelTTF, cc.LabelTTF._textAlign = ["left", "center", "right"], cc.LabelTTF._textBaseline = ["top", "middle", "bottom"], cc.LabelTTF._checkRegEx = /(.+?)([\s\n\r\-\/\\\:]|[\u4E00-\u9FA5]|[\uFE30-\uFFA0])/, cc.LabelTTF._reverseCheckRegEx = /(.*)([\s\n\r\-\/\\\:]|[\u4E00-\u9FA5]|[\uFE30-\uFFA0])/, cc.LabelTTF._checkEnRegEx = /[\s\-\/\\\:]/, cc.LabelTTF._fontStyleRE = /^(\d+)px\s+['"]?([\w\s\d]+)['"]?$/, cc.LabelTTF.create = function(e, t, n, r, i, s) {
    return new cc.LabelTTF(e, t, n, r, i, s)
}, cc.USE_LA88_LABELS ? cc.LabelTTF._SHADER_PROGRAM = cc.SHADER_POSITION_TEXTURECOLOR : cc.LabelTTF._SHADER_PROGRAM = cc.SHADER_POSITION_TEXTUREA8COLOR, cc.LabelTTF.__labelHeightDiv = cc.newElement("div"), cc.LabelTTF.__labelHeightDiv.style.fontFamily = "Arial", cc.LabelTTF.__labelHeightDiv.style.position = "absolute", cc.LabelTTF.__labelHeightDiv.style.left = "-100px", cc.LabelTTF.__labelHeightDiv.style.top = "-100px", cc.LabelTTF.__labelHeightDiv.style.lineHeight = "normal", document.body ? document.body.appendChild(cc.LabelTTF.__labelHeightDiv) : cc._addEventListener(window, "load", function() {
    ...
    _computeEaseTime: function(e) {
        ...
        for (var n = 0, r = t.length; n < r; n++) e = t[n].easing(e);
        return e
    },
    step: function(e) {
    ...
    ctor: function(e) {
        ...
        if (n >= 0) {
            var r = t[0],
                i;
            for (var s = 1; s < n; s++) t[s] && (i = r, r = cc.Sequence._actionOneTwo(i, t[s]));
    ...
    update: function(e) {
        ...
        var t = this._innerAction,
            ...
            i = this._nextDt;
        if (e >= i) {
            while (e > i && this._total < r) t.update(1), this._total++, t.stop(), t.startWithTarget(this.target), i += t._duration / n, this._nextDt = i;
    ...
    reverse: function() {
        var e = cc.Repeat.create(this._innerAction.reverse(), this._times);
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    },
    setInnerAction: function(e) {
        this._innerAction != e && (this._innerAction = e)
    ...
    reverse: function() {
        var e = cc.RepeatForever.create(this._innerAction.reverse());
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    },
    setInnerAction: function(e) {
        this._innerAction != e && (this._innerAction = e)
    ...
    ctor: function(e) {
        ...
        if (n >= 0) {
            var r = t[0],
                i;
            for (var s = 1; s < n; s++) t[s] && (i = r, r = cc.Spawn._actionOneTwo(i, t[s]));
            this.initWithTwoActions(r, t[n])
        }
    },
    initWithTwoActions: function(e, t) {
    ...
    t.length > 0 && t[t.length - 1] == null && cc.log("parameters should not be ending with null in Javascript");
    var n = t[0];
    for (var r = 1; r < t.length; r++) t[r] != null && (n = cc.Spawn._actionOneTwo(n, t[r]));
    return n
    ...
    reverse: function() {
        var e = cc.RotateBy.create(this._duration, -this._angleX, -this._angleY);
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    }
    ...
    update: function(e) {
        ...
        if (this.target) {
            ...
            } else this.target.setPosition(r.x + t, r.y + n)
        }
    },
    reverse: function() {
        var e = cc.MoveBy.create(this._duration, cc.p(-this._positionDelta.x, -this._positionDelta.y));
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    }
}), cc.MoveBy.create = function(e, t, n) {
...
}), cc.MoveTo.create = function(e, t, n) {
    ...
    ctor: function(e, t, n) {
        cc.SkewTo.prototype.ctor.call(this), n !==
            undefined && this.initWithDuration(e, t, n)
    },
    initWithDuration: function(e, t, n) {
        var r = !1;
    ...
    reverse: function() {
        var e = cc.SkewBy.create(this._duration, -this._skewX, -this._skewY);
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    }
    ...
    update: function(e) {
        ...
        if (this.target) {
            ...
            } else this.target.setPosition(i.x + r, i.y + n)
        }
    },
    reverse: function() {
        var e = cc.JumpBy.create(this._duration, cc.p(-this._delta.x, -this._delta.y), this._height, this._jumps);
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    }
}), cc.JumpBy.create = function(e, t, n, r, i) {
...
}), cc.JumpTo.create = function(e, t, n, r, i) {
    ...
    update: function(e) {
        ...
        if (this.target) {
            ...
            } else this.target.setPosition(h.x + l, h.y + c)
        }
    },
    reverse: function() {
        var e = this._config,
            t = [cc.pAdd(e[1], cc.pNeg(e[2])), cc.pAdd(e[0], cc.pNeg(e[2])), cc.pNeg(e[2])],
            n = cc.BezierBy.create(this._duration, t);
    ...
    reverse: function() {
        var e = cc.ScaleBy.create(this._duration, 1 / this._endScaleX, 1 / this._endScaleY);
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    },
    clone: function() {
    ...
    reverse: function() {
        var e = cc.Blink.create(this._duration, this._times);
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    }
    ...
    reverse: function() {
        var e = cc.TintBy.create(this._duration, -this._deltaR, -this._deltaG, -this._deltaB);
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    }
    ...
    update: function(e) {},
    reverse: function() {
        var e = cc.DelayTime.create(this._duration);
        return this._cloneDecoration(e), this._reverseEaseList(e), e
    },
    clone: function() {
    ...
    reverse: function() {
        ...
        var s = cc.Animation.create(n, e.getDelayPerUnit(), e.getLoops());
        s.setRestoreOriginalFrame(e.getRestoreOriginalFrame());
        var o = cc.Animate.create(s);
    ...
    reverse: function() {
        var e = cc.EaseBezierAction.create(this._inner.reverse());
...
}), cc.EaseCubicActionIn.create = function(e) {
    ...
    var t = [];
    for (var n = e.length - 1; n >= 0; n--) t.push(cc.p(e[n].x, e[n].y));
    return t
}, cc.copyControlPoints = function(e) {
    var t = [];
    for (var n = 0; n < e.length; n++) t.push(cc.p(e[n].x, e[n].y));
    return t
    ...
    initWithDuration: function(e, t, n) {
        if (!t || t.length == 0) throw "Invalid configuration. It must at least have one control point";
    ...
    reverse: function() {
        var e = this._points.slice(),
            t, n = e[0];
        for (var r = 1; r < e.length; ++r) t = e[r], e[r] = cc.pSub(t, n), n = t;
        var i = cc.reverseControlPoints(e);
        n = i[i.length - 1], i.pop(), n.x = -n.x, n.y = -n.y, i.unshift(n);
        for (var r = 1; r < i.length; ++r) t = i[r], t.x = -t.x, t.y = -t.y, t.x += n.x, t.y += n.y, i[r] = t, n = t;
        return cc.CardinalSplineBy.create(this._duration, i, this._tension)
    },
    updatePosition: function(e) {
        var t = this._startPosition,
            n = e.x + t.x,
